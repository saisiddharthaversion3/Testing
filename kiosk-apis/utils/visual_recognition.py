...
def run_recognition(inputImagePath):
    video_capture = cv2.VideoCapture(0)

    # Load a sample picture and learn how to recognize it.
    input_image = face_recognition.load_image_file(inputImagePath)
    ...
    while True:
        ...
        for (top, right, bottom, left), name in zip(face_locations, face_names):
            ...
            #Set the face found flag to true
            # found_face = True
            #Extract the face
